...
public class SerializableDictionaryPropertyDrawer : PropertyDrawer
{
	...
	public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
	{
		...
		SetNames(keyArrayProperty, valueArrayProperty);
	...
	private void SetNames(SerializedProperty keyArrayProperty, SerializedProperty valueArrayProperty)
	{
		foreach (var entry in EnumerateEntries(keyArrayProperty, valueArrayProperty))
		{
			var keyProperty = entry.keyProperty;
			...
			if(valueProperty.objectReferenceValue!=null)
				keyProperty.stringValue = valueProperty.objectReferenceValue.name;
		}
	}
...
//public class MyDictionaryDrawer1 : PropertyDrawer
//{
